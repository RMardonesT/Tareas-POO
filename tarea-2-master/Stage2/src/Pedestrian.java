...
public class Pedestrian {
    ...
    public Pedestrian (Comuna comuna, double speed, double deltaAngle, int state, double I_time, int i){
        this.id = i;
        this.comuna = comuna;
    ...
    public int getNewState(Pedestrian person2, double d, double P)
    {
        newState = state;
