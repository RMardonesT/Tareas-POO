...
public class Simulador {
    ...
    private double N, I, I_time, speed, delta_t, deltaAngle, samplingTime, d, p0, M, p1, p2;
    ...
    private ArrayList populate_comuna(){
        ...
        for (int i=0; i< N; i++)
        {
            ...
            if(i<num_maskInf || (i >= I && i < I+num_maskSus))
            {
                Mask = true;
            }
            else
            ...
            Individuo person = new Individuo (comuna, speed, deltaAngle, state, I_time, Mask);
