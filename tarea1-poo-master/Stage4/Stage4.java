import sources4.*; // Importando todas las clases de sources1
import java.io.File;
...
public class Stage4 {
    public static void main(String [] args) throws IOException
    {
        ...
        //Tiempo de sampleo
        double samplingTime = 1;  // 1 [s] inicia en 1 segundo, cercano al final de la simulacion aumenta

        //arreglo con los parámetros extraidos desde el archivo configurationFile.txt
        double [] parameters = {N, I, I_time, speed, delta_t, deltaAngle, samplingTime, d, p0, M, p1, p2, Num_vac, Vac_size, Vac_time};
